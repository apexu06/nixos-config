...
// taken from https://github.com/noctalia-dev/noctalia-shell/blob/main/Services/Media/CavaService.qml
...
Singleton {
  ...
  */
    property bool shouldRun: PowerProfiles.profile !== PowerProfile.PowerSaver

    property var values: Array(barsCount).fill(0)
    property int barsCount: 8
